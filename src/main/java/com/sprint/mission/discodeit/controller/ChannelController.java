...
public class ChannelController {
    ...
    public ResponseEntity<ChannelResponse> createPublic(@Valid @RequestBody CreatePublicChannelRequest request) {
    ...
    public ResponseEntity<ChannelResponse> createPrivate(@Valid @RequestBody CreatePrivateChannelRequest request) {
